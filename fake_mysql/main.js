...
function handleQuery(query) {
 ...
 this.sendDefinitions([
  ...
  this.newDefinition({ name: "Query", columnType: consts.MYSQL_TYPE_VAR_STRING }),
  this.newDefinition({ name: "Constraint", columnType: consts.MYSQL_TYPE_VAR_STRING }),
 ]);
 this.sendRows([
  [13333337, query, 123456789]
 ]);
}
